...
public class EmployeeInvoiceService {
    ...
    public EmployeeInvoice generateInvoice(String employeeId) {
        EmployeeDto employee = fetchEmployeeData(employeeId).join(); // Use async method for fetching employee data
        ...
        invoice.setEmployeeName(employee.getFirstName());
    ...
    // Asynchronous method to fetch employee data from external service
    @Async
    public CompletableFuture<EmployeeDto> fetchEmployeeData(String employeeId) {
